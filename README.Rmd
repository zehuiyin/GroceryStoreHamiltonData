...
Load and plot `grocery_CT` vector data. The data contains the geometry of all the census tracts in Hamilton and have a variable showing the count of grocery stores in that census tract.
